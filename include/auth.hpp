...
public:
    ...
    */
    explicit FirebaseAuth(FirebaseDatabase *firebase_db, App *firebase_app, QObject *parent = nullptr);
    ...
    */
    Q_INVOKABLE void sign_up(QString email, QString password, QString username, QString phone);
...
private:
    ...
    FirebaseDatabase *firebase_firestore; /**< Pointer to the associated FirebaseFirestore instance. */
};
